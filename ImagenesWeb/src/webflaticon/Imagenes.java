...
public class Imagenes {
	...
	//metodo para que una vez leida la url y pasada a un String me reemplaze las comillas dobles " por simples '
	    ...
	    public static void getWebArchivo(String enlaceWeb, File nombreArchivo) { //lectura de archivos a nivel BITS (Internet a local)
			...
			try { // puede haber una excepcion que sea que la url sea incorrecta
				...
				InputStream documento = urlConexion.getInputStream(); //getinputStream lo lee  y lo guarda en un inputStream y se lee a nivel bits
				FileOutputStream guardar = new FileOutputStream(nombreArchivo); //FileOutputStream lectura de archivo en formato binario bits
